...
public class RevocaConsensoCittadinoService extends BaseCittadinoService<RevocaConsensoCittadino, RevocaConsensoCittadinoResponse> {
	...
	@Override
	protected void checkServiceParams(RevocaConsensoCittadino req) {
	...
	@Override
	protected RevocaConsensoCittadinoResponse execute(RevocaConsensoCittadino req,CsiLogAudit logaudit) {
		
		RevocaConsensoCittadinoResponse res = new RevocaConsensoCittadinoResponse();
		...
		if(response.getBody()!=null && response.getBody().getElencoProfili()!=null && response.getBody().getElencoProfili().getDatianagrafici()!=null) {
			...
			Consenso consensoInserito= consensoBean.revocaConsenso(req.getConsenso(), logaudit, req.getRichiedente().getCodiceFiscale());
