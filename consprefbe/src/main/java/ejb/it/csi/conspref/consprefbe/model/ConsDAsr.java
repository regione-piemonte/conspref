...
public class ConsDAsr implements Serializable {
	...
	@Id
	@SequenceGenerator(name="CONS_D_ASR_CODASR_GENERATOR", sequenceName="CONS_D_ASR_COD_ASR_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CONS_D_ASR_CODASR_GENERATOR")
	@Column(name="cod_asr")
	...
	public ConsTConsenso addConsTConsenso(ConsTConsenso consTConsenso) {
		...
		consTConsenso.setConsDAsr(this);
	...
	public ConsTConsenso removeConsTConsenso(ConsTConsenso consTConsenso) {
		...
		consTConsenso.setConsDAsr(null);
