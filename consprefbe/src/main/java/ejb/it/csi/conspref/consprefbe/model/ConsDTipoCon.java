...
/**
 * The persistent class for the cons_d_tipo_cons database table.
 * 
 */
@Entity
@Table(name="cons_d_tipo_cons")
@NamedQuery(name="ConsDTipoCon.findAll", query="SELECT c FROM ConsDTipoCon c")
public class ConsDTipoCon implements Serializable {
	private static final long serialVersionUID = 1L;

	@Id
	@SequenceGenerator(name="CONS_D_TIPO_CONS_TIPOCONSENSO_GENERATOR", sequenceName="CONS_D_TIPO_CONS_TIPO_CONSENSO_SEQ")
	@GeneratedValue(strategy=GenerationType.SEQUENCE, generator="CONS_D_TIPO_CONS_TIPOCONSENSO_GENERATOR")
	...
	@OneToMany(mappedBy="consDTipoCon")
	...
	public ConsDInformativa addConsDInformativa(ConsDInformativa consDInformativa) {
		...
		consDInformativa.setConsDTipoCon(this);
	...
	public ConsDInformativa removeConsDInformativa(ConsDInformativa consDInformativa) {
		...
		consDInformativa.setConsDTipoCon(null);
