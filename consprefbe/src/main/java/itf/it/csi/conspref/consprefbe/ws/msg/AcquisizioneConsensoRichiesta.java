...
@XmlType(name = "acquisizioneConsensoRichiesta", propOrder = {
		"requestId",
		"codiceServizio",
		"cfRichiedente",
		"idAura",
...
public class AcquisizioneConsensoRichiesta {
    ...
    @XmlElementWrapper(name="elencoConsensi", required = true)
   	@XmlElement(name="consenso", required = true)
   	protected List<ConsensoAsrRegione> elencoConsensi;
	...
	/**
	 * @return the elencoConsensi
	 */
	public List<ConsensoAsrRegione> getElencoConsensi() {
		return elencoConsensi;
	}

	/**
	 * @param elencoConsensi the elencoConsensi to set
	 */
	public void setElencoConsensi(List<ConsensoAsrRegione> elencoConsensi) {
		this.elencoConsensi = elencoConsensi;
	}
