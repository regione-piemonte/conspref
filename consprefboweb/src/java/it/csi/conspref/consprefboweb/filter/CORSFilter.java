...
import it.csi.conspref.consprefboweb.util.Constants;
...
public class CORSFilter implements Filter {
	...
	private enum Param{
		...
		ACCESS_CONTROL_ALLOW_HEADERS("Authorization, Origin, Accept, X-Requested-With, Content-Type, Access-Control-Request-Method, Access-Control-Request-Headers"), //, Shib-Identita-CodiceFiscale
