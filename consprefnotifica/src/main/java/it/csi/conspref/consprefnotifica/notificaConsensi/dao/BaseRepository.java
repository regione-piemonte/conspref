...
public class BaseRepository {
	...
	protected void setCreazione(Object o) {

		Timestamp now=new Timestamp(new Date().getTime());

		try {

			invokeSingleParamMethod(o, "setNotAvvio", Timestamp.class, now);
			invokeSingleParamMethod(o, "setNotFine", Timestamp.class, null);
			...
			throw new IllegalArgumentException("Impossibile impostare parametri <data> ", e);
		}
	}

	protected void setModifica(Object o) {
		
		Timestamp now=new Timestamp(new Date().getTime());

		try {
			invokeSingleParamMethod(o, "setNotFine", Timestamp.class, now);
			invokeSingleParamMethod(o, "setDataFine", Date.class, now);
			invokeSingleParamMethod(o, "setDataModifica", Timestamp.class, now);
